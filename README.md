...
Готовая **Зомби Хоррор сборка** для вашего Counter-Strike 1.6 сервера! 
> ⚠️ **Внимание:** Данная сборка была слита на других сайтах. В этой версии всё исправлено, настроено и готовы к работе умные боты **EBOT**.
...
* 🤖 **Интеграция EBOT** — боты уже настроены и отлично играют на зомби-картах.
* 🧟 **Атмосфера Horror** — уникальные звуки, мрачные темные текстуры и плагины освещения.
* 🛠 **Полная оптимизация** — стабильный FPS, исправлены критические баги и вылеты.
* 📦 **FastDL** — готова к быстрой загрузке файлов игроками (звуки, модели, спрайты).

---

## 💻 Установка
1. Перейдите в раздел **Releases** или нажмите на кнопку **Скачать Мод**.
